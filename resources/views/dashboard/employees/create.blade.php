            ...
            <div class="d-flex flex-column" style="height: 96.5vh;">
                <div class="d-flex mb-3">
                    <div
                        ...
                        <h5 class="m-0 text-uppercase">Tambah Data Pegawai</h5>
                    </div>
                </div>
                <form class="h-100" action="/employees" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex h-100">
                        <div class="p-3 bg-white rounded shadow">
                            <div class="mb-3">
                                ...
                                <img class="rounded d-none">
                            </div>
                            <div class="mb-3">
                                <label for="photo" class="form-label">File Gambar</label>
                                <input type="file" class="form-control" onchange="previewImage(this)" name="photo"
                            ...
                            <div class="p-3 h-100 bg-white pb-5 rounded shadow" style="position: relative;">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('nip') }}" name="nip"
                                        id="nip" required autocomplete="off" autofocus>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('position') }}"
                                        name="position" id="position" required autocomplete="off">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('phone_number') }}"
                                        name="phone_number" id="phone_number" required autocomplete="off">
                                </div>
                                <div class="mb-3">
