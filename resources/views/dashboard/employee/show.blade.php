...
@section('content')
    ...
    <div class="row gx-3">
        <div class="col-md-5">
            <div class="row g-0 justify-content-center text-center bg-white rounded shadow mb-3" style="padding: 2rem;">
                <div class="employee-image bg-danger rounded-circle mb-3">
                    <img src="{{ asset('storage/' . $employee->photo) }}" class="rounded-circle">
                </div>
                <h4>{{ $employee->name }}</h4>
                <h5>{{ $employee->nip }}</h5>
            </div>
            <div class="bg-white rounded shadow text-center" style="padding: 2rem;">
                <div class="row mb-3">
        ...
        <div class="col-md-7">
            <div class="bg-white rounded shadow p-3 h-100 w-100">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
                            ...
                            aria-selected="false">Proposal</button>
