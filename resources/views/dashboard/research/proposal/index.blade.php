...
@section('app-content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i> Data Proposal Penelitian</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item">Data Proposal</li>
            <li class="breadcrumb-item active"><a href="#">Data Proposal Penelitian</a></li>
        </ul>
    </div>
    <div class="row">
        @can('employee')
                    ...
                    <div class="d-flex justify-content-between">
                        @if (session()->has('created'))
                            <div class="alert alert-success flex-grow-1">
                                Berhasil Melakukan Pengajuan Proposal Penelitian!
                        ...
                        @elseif (session()->has('updated'))
                            <div class="alert alert-success flex-grow-1">
                                Berhasil Memperbaharui Data Proposal Penelitian!
                        ...
                        @else
                            <div class="alert alert-info flex-grow-1">
                                Klik Tombol <strong>Pengajuan Baru</strong> Untuk Melakukan Pengajuan Proposal Penelitian!
                            </div>
                        @endif
                        <div class="ml-3 pt-1">
                ...
                <div class="col-md-12">
                    <div class="d-flex justify-content-between">
                        @if (session()->has('APPROVED'))
                            <div class="alert alert-success flex-grow-1">
                                Berhasil Menyetujui Pengajuan Proposal Penelitian dengan judul:
                                <strong>{{ session()->get('APPROVED') }}</strong>
                            </div>
                        @elseif (session()->has('REJECTED'))
                            <div class="alert alert-success flex-grow-1">
                                Berhasil Menolak Pengajuan Proposal Penelitian dengan judul:
                            ...
                            <tbody>
                                @foreach ($proposals as $proposal)
                                    <tr>
                                        ...
                                        <td class="td-fit">
                                            <a href="/{{ explode('.', Route::currentRouteName())[0] }}/{{ $proposal->research_id }}"
