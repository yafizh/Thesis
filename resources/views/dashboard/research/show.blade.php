                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $research->reviewer->name }}" disabled>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Tanggal Pengajuan</label>
                                <input type="text" class="form-control" value="{{ $research->submitted_date }}" disabled>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Waktu Pengajuan</label>
                                <input type="text" class="form-control" value="{{ $research->submitted_time }}" disabled>
                            </div>
                            <div class="form-group">
                        ...
                        @if ($research->report_reviewer)
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <a href="{{ asset('storage/' . $research->file_report) }}" target="_blank">FULL TEXT</a>
                                </div>
                            </div>
                        @endif
                    </div>
