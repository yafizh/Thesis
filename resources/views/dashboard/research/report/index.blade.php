                    ...
                    <div class="d-flex justify-content-between">
                        @if (session()->has('created'))
                            <div class="alert alert-success flex-grow-1">
                                Berhasil Melakukan Penyerahan Laporan Akhir Penelitian!
                        ...
                        @elseif (session()->has('updated'))
                            <div class="alert alert-success flex-grow-1">
                                Berhasil Memperbaharui Data Laporan Akhir Penelitian!
                        ...
                        @elseif (session()->has('deleted'))
                            <div class="alert alert-success flex-grow-1">
                                Berhasil Membatalkan Penyerahan Laporan Akhir Penelitian dengan judul:
                                <strong>{{ session()->get('deleted') }}</strong>
                            </div>
                        @else
                            <div class="alert alert-info flex-grow-1">
                                Klik Tombol <strong>Detail</strong> Untuk Memperbaharui atau Menghapus Laporan Akhir Penelitian!
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="d-flex justify-content-between">
                        @if (session()->has('APPROVED'))
                            <div class="alert alert-success flex-grow-1">
                                Berhasil Menyetujui Penyerahan Laporan Akhir Penelitian dengan judul:
                                <strong>{{ session()->get('APPROVED') }}</strong>
                            </div>
                        @elseif (session()->has('REJECTED'))
                            <div class="alert alert-success flex-grow-1">
                                Berhasil Menolak Penyerahan Laporan Akhir Penelitian dengan judul:
