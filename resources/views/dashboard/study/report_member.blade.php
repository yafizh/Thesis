...
@section('app-content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i> Laporan Anggota Pengkajian</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item">Laporan</li>
            <li class="breadcrumb-item active"><a href="#">Anggota Pengkajian</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Pengkaji</th>
